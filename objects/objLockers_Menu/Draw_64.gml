...
draw_set_color(color_weapon);
draw_text(35, 298, objSettings_Tracker.weapon_pellets);
draw_set_color(color_special);
draw_text(100, 298, objSettings_Tracker.special_pellets);
draw_set_color(color_ultra);
draw_text(165, 298, objSettings_Tracker.ultra_pellets);
